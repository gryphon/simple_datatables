...
1. Create simple meta_search and will_paginate controller action as usual and add ".datatables" format
...
2. Use standard datatables initializer options for creating table:
...
3. Create Jsonify view with column values for columns listed in aoColumns. See example for clarification.
